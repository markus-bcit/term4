...
variable "vpc_security_group_public" {
  ...
  default = {
    name        = "vpc_security_group_public"
...
variable "vpc_security_group_private" {
  ...
  default = {
    name        = "vpc_security_group_private"
    description = "Allows ssh from anywhere, http from within only the vnet"
    ingress_rules = [
      {
        description = "allow ssh from everywhere"
        ip_protocol = "tcp"
      ...
      },
      {
        ...
        rule_name   = "allow http from vnet"
      },
    ]
    egress_rules = [
      {
