...
cursor = db.cursor()
AUTH_SERVICE_URL_SIGNUP = 'http://auth:8000/signup'
AUTH_SERVICE_URL_LOGIN = 'http://auth:8000/login'
app.secret_key = b'\xc3\xd6_\xb86\xad1GP\xf9@Y\x14\xc5\xfa\xd9|m\x90\x14\x12\xb48)'
